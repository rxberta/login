...
if ($login == "" || $login == null){
    ...
    if($insert){
        ...
        echo"<script language='javascript' type='text/javascript'> alert('Não foi possivel cadastrar esse usuário');window.location.href='cadastro.html';</script>";
    }
}
}
